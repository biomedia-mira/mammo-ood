...
from architectures.dinov3.layers.fp8_linear import convert_linears_to_fp8
...
def build_model(args, only_teacher=False, img_size=224, device=None):
    if "vit" in args.arch:
        ...
        raise NotImplementedError("ConvNeXt support was removed from the vendored DINOv3 core for this ViT-only mammography setup.")
    else:
...
def build_model_for_eval(
    ...
    if pretrained_weights is None or pretrained_weights == "":
        ...
        from architectures.dinov3.checkpointer import load_checkpoint
        ...
        from architectures.dinov3.checkpointer import init_model_from_checkpoint_for_evals
