...
from architectures.dinov3.utils import utils
...
def ac_compile_parallelize(
    ...
    from architectures.dinov3.models.convnext import ConvNeXt
    from architectures.dinov3.models.vision_transformer import DinoVisionTransformer
