...
import architectures.dinov3.distributed as distributed
from architectures.dinov3.checkpointer import init_fsdp_model_from_checkpoint
from architectures.dinov3.configs import get_default_config
from architectures.dinov3.data import DataAugmentationDINO
from architectures.dinov3.fsdp.ac_compile_parallelize import ac_compile_parallelize
from architectures.dinov3.layers.dino_head import DINOHead
from architectures.dinov3.loss import DINOLoss, GramLoss, KoLeoLoss, KoLeoLossDistributed, iBOTPatchLoss
from architectures.dinov3.models import build_model_from_cfg
from architectures.dinov3.train.cosine_lr_scheduler import linear_warmup_cosine_decay
from architectures.dinov3.train.param_groups import fuse_params_groups, get_params_groups_with_decay_fsdp
from architectures.dinov3.utils import count_parameters
...
class SSLMetaArch(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.ibot_patch_loss = iBOTPatchLoss(
            ...
            compile_sinkhorn=bool(cfg.train.compile),
        )
    ...
    def forward_backward(
        ...
        device = next(self.student.backbone.parameters()).device
