...
from architectures.dinov3.distributed import get_process_subgroup, get_subgroup_size
...
class iBOTPatchLoss(nn.Module):
    def __init__(self, patch_out_dim, student_temp=0.1, center_momentum=0.9, compile_sinkhorn=True):
        super().__init__()
